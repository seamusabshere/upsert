...
Tested to be much about 60% faster on PostgreSQL and 60&ndash;90% faster on MySQL and SQLite3 than comparable methods (see the tests, which fail if they are not faster).
